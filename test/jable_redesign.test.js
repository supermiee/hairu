 ...
 *  - 数据内核为同目录 jable_redesign_core.js（统一基线 ?v=19）
...
test('订阅 JSON 版本一致，内核为同目录 jable_redesign_core.js?v=19', function () {
    ...
    var coreUrl = 'https://supermiee.github.io/hairu/apps/jable_redesign/jable_redesign_core.js?v=19';
