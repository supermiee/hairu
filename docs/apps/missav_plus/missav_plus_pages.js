...
(function () {
    ...
    var CORE_URL = PUBLISH_BASE + 'apps/missav_plus/missav_plus_core.js?v=16';
    ...
    function renderListRoute(pageSource, params) {
        return $('hiker://empty#' + pageSource).rule(function (payload) {
            ...
            payload.url = source;
            try { requirejs('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_pages.js?v=16').renderList(payload); }
            catch (e) { $.require('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_pages.js?v=16').renderList(payload); }
        }, params);
    }
    ...
    function pageRoute(name, params, flags) {
        return $('hiker://empty' + (flags || '')).rule(function (payload) {
            try { requirejs('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_pages.js?v=16').renderRouter(payload); }
            catch (e) { $.require('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_pages.js?v=16').renderRouter(payload); }
    ...
    function directoryRoute(pageSource, params) {
        return $('hiker://empty#' + pageSource).rule(function (payload) {
            ...
            source = String(source).split('@rule=')[0];
            payload.url = source;
            try { requirejs('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_pages.js?v=16').renderDirectory(payload); }
            catch (e) { $.require('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_pages.js?v=16').renderDirectory(payload); }
        }, params);
    }
    ...
    function favoriteToggle(item) {
        return $('hiker://empty').lazyRule(function (payload) {
            var app;
            try { app = requirejs('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16'); }
            catch (ignore) { app = $.require('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16'); }
    ...
    function renderSettings() {
        ...
        setResult([
            ...
            { title: '🧹 清除缓存与本地数据', url: $('hiker://empty#noLoading#').lazyRule(function () {
                if (typeof confirm === 'function') {
                    confirm({
                        ...
                        confirm: $.toString(function () {
                            var app;
                            try { app = requirejs('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16'); }
                            catch (e) { app = $.require('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16'); }
                            app.clearLocal();
                ...
                try { requirejs('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16').clearLocal(); } catch (e) { $.require('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16').clearLocal(); }
                refreshPage(false);
                return 'toast://已清除';
            }), col_type: 'text_center_1' }
        ]);
    ...
    function renderPlaySettings() {
        ...
        for (var i = 0; i < options.length; i++) {
            result.push({ title: (selected === options[i][0] ? '✓ ' : '') + options[i][1], url: $('hiker://empty#noLoading#').lazyRule(function (value) {
                var app;
                try { app = requirejs('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16'); } catch (ignore) { app = $.require('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16'); }
    ...
    function renderVerification() {
        ...
        setResult([
            ...
            { title: '第二步：验证成功后，点此返回并刷新', url: $('hiker://empty#noLoading#').lazyRule(function () {
                ...
                try { requirejs('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16').clearPageCache(); } catch (e) { $.require('https://supermiee.github.io/hairu/apps/missav_plus/missav_plus_core.js?v=16').clearPageCache(); }
                back(true);
