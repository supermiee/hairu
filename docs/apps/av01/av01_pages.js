...
(function () {
    ...
    var CORE_URL = PUBLISH_BASE + 'apps/av01/av01_core.js?v=17';
    ...
    function routeList(url, title, flags) {
        return $('hiker://empty#' + pagedSource(url) + (flags || '')).rule(function (payload) {
            try { requirejs('https://supermiee.github.io/hairu/apps/av01/av01_pages.js?v=17').renderList(payload); }
            catch (e) { $.require('https://supermiee.github.io/hairu/apps/av01/av01_pages.js?v=17').renderList(payload); }
    ...
    function pageRoute(name, params, flags) {
        return $('hiker://empty' + (flags || '')).rule(function (payload) {
            try { requirejs('https://supermiee.github.io/hairu/apps/av01/av01_pages.js?v=17').renderRouter(payload); }
            catch (e) { $.require('https://supermiee.github.io/hairu/apps/av01/av01_pages.js?v=17').renderRouter(payload); }
    ...
    function favoriteToggle(item) {
        return $('hiker://empty').lazyRule(function (payload) {
            var app;
            try { app = requirejs('https://supermiee.github.io/hairu/apps/av01/av01_core.js?v=17'); }
            catch (ignore) { app = $.require('https://supermiee.github.io/hairu/apps/av01/av01_core.js?v=17'); }
    ...
    function renderSettings() {
        ...
        setResult([
            ...
            { title: '🧹 清除缓存与本地数据', url: $('hiker://empty#noLoading#').lazyRule(function () {
                if (typeof confirm === 'function') {
                    confirm({
                        ...
                        confirm: $.toString(function () {
                            var app2;
                            try { app2 = requirejs('https://supermiee.github.io/hairu/apps/av01/av01_core.js?v=17'); }
                            catch (e) { app2 = $.require('https://supermiee.github.io/hairu/apps/av01/av01_core.js?v=17'); }
                            app2.clearLocal();
                ...
                try { requirejs('https://supermiee.github.io/hairu/apps/av01/av01_core.js?v=17').clearLocal(); } catch (e) { $.require('https://supermiee.github.io/hairu/apps/av01/av01_core.js?v=17').clearLocal(); }
                refreshPage(false);
                return 'toast://已清除';
            }), col_type: 'text_center_1' }
        ]);
    ...
    function renderVerification() {
        ...
        setResult([
            ...
            { title: '第二步：验证成功后，点此返回并刷新', url: $('hiker://empty#noLoading#').lazyRule(function () {
                ...
                try { requirejs('https://supermiee.github.io/hairu/apps/av01/av01_core.js?v=17').clearPageCache(); } catch (e) { $.require('https://supermiee.github.io/hairu/apps/av01/av01_core.js?v=17').clearPageCache(); }
                back(true);
